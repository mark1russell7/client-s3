...
import type { S3ListInput, S3ListOutput, S3ListObject } from "../../types.js";
 ...
 */
export async function s3List(input: S3ListInput): Promise<S3ListOutput> {
  ...
  const contents: S3ListObject[] = (response.Contents || []).map((obj) => ({
    key: obj.Key || "",
    size: obj.Size || 0,
